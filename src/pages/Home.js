            ...
            gsap.fromTo(
                '.parralax-gradient',
                {
                    backgroundPosition: `50% ${
                        -window.innerHeight * getRatio(roadmap)
                    }px`,
                },
                {
                    backgroundPosition: () =>
                    ...
                    <div className="col-12 col-md-6">
                        <div className="container pb-1 mb-4">
                            ...
                            <p>
                                ...
                                each piece of your website to meet your
                        ...
                        <div className="text-body container pb-1">
                            ...
                            <hr />
                            <p>
                                Custom elements bring the user experience to
                                another level! Our team is more than willing to
                                take on any idea that you can throw at us.
                            </p>
                        </div>
                    </div>
                </div>
