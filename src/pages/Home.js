...
const Home = () => {
  ...
  useEffect(() => {
    pannelR.current.style.setProperty("--mouse-x", "0%");
    ...
    const moveGradient = (e) => {
      ...
      if (pannelR) {
        pannelR.current.style.setProperty("--mouse-x", mouseX.toString() + "%");
        pannelR.current.style.setProperty("--mouse-y", mouseY.toString() + "%");
      }
    };
              ...
              <div className='shineCard-info-wrapper'>
                <div className='shineCard-info'>
                  ...
                  <div className='shineCard-info-title'>
                    ...
                    <h4>Crank the volume of your branding</h4>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className='shineCard-info-wrapper'>
                <div className='shineCard-info'>
                  ...
                  <div className='shineCard-info-title'>
                    ...
                    <h4>Easy to explore = More conversions</h4>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className='shineCard-info-wrapper'>
                <div className='shineCard-info'>
                  ...
                  <div className='shineCard-info-title'>
                    ...
                    <h4>Connect your site to key services</h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='shineCard-content'>
              ...
              <div className='shineCard-info-wrapper'>
                <div className='shineCard-info'>
                  ...
                  <div className='shineCard-info-title'>
                    <h3>More</h3>
                    <h4>Learn more about who we are and how we can help...</h4>
                  </div>
                </div>
              </div>
            </div>
